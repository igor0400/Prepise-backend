...
export class TagsService {
  ...
  async deleteTag(tagId: number) {
    ...
    await this.userFollowingTagRepository.destroy({ where: { tagId: tagId } });
  ...
  private async createUTags(args: { repository: any; dto: CreateUserTagsDto }) {
  ...
  private async deleteUTags(args: { repository: any; dto: CreateUserTagsDto }) {
    const deletedTags = [];
